(function ($) {
   ...
   =============================================*/
    ...
    const processingSlider = new Swiper('.processing-hero-slider', {
        loop: true,
        autoplay: {
            delay: 5000,
            disableOnInteraction: false,
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const preferencesBtn = document.getElementById('cookiesPreferencesBtn');
        const acceptAllBtn = document.getElementById('cookiesAcceptAll');
        const closeBtn = document.getElementById('cookiesModalClose');
        const rejectAllBtn = document.getElementById('cookiesRejectAll');
        ...
        const toggles = {
            ...
            preferences: document.getElementById('cookiesPreferencesToggle')
        };
   ...
   =======================================*/
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const mobileMenuClose = document.querySelector('.mobile-navigation-close-icon');
        ...
        const handleMobileSubmenus = function () {
            const hasChildren = document.querySelectorAll('.offcanvas-navigation .has-children');

            hasChildren.forEach(function (item) {
                const link = item.querySelector('a');
                if (link) {
                    link.addEventListener('click', function (e) {
                        if (window.innerWidth < 1200) { // Only on mobile
                            e.preventDefault();
    ...
    $(document).ready(function () {
        ...
        $("#mobile-menu-trigger").on('click', function () {
            $(".bm-burger-button").trigger('click');
        });

        // Close menu when clicking on links
        $(".offcanvas-navigation a").on('click', function () {
            $(".bm-cross-button").trigger('click');
        });

        // Handle submenu toggle
        $('.offcanvas-navigation .has-children > a').on('click', function (e) {
            if ($(window).width() < 1200) {
                ...
                if ($submenu.length) {
                    ...
                    $parent.siblings('.has-children').removeClass('active').find('.sub-menu').slideUp();
                }
            }
        });
    });
